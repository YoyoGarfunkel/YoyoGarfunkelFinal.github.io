  ...
  function (lang, /*on,Deferred, */array, html, /*keys, */htmlEntities, jimuUtils, ItemNode,
    ...
    mo.createBookMarkNode = function (bookmark, nls, folderUrl, display, a11y) {
      ...
      if (bookmark.thumbnail ||
        ...
        var url = bookmark.thumbnail
        if (bookmark.thumbnail && bookmark.thumbnail.url) {
          url = bookmark.thumbnail.url; // thumbnail from mapViewer 4X ,#19531
        }
        thumbnail = jimuUtils.processUrlInWidgetConfig(url, folderUrl);
      } else {
